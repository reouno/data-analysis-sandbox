...
DATABASES = {
    "default": {
        ...
        "USER": os.environ.get("SQL_USER", "api_user"),
        "PASSWORD": os.environ.get("SQL_PASSWORD", "pass123"),
...
TIME_ZONE = os.environ.get('TIME_ZONE', default='Asia/Tokyo')
